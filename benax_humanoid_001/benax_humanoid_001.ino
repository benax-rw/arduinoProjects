...
void doReceive(){
  ...
  if(rf95.recv(buf, &len)){
    ...
    if(mString.indexOf("forward")>=0){
     ...
     else if(mString.indexOf("en avant")>=0){
      int duration;
      mString.replace("en avant", "");
      mString.trim();
      if(mString !=""){
        duration = mString.toInt();
        moveForward(duration*1000);
      ...
      doReply("En train de marcher en avant..."); 
    }

      else if(mString.indexOf("imbere")>=0){
      int duration;
      mString.replace("imbere", "");
      mString.trim();
      if(mString !=""){
        duration = mString.toInt();
        moveForward(duration*1000);
